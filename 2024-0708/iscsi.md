...
通常，在企业领域我们听到的 SAN 供应商包括像戴尔 EMC、IBM、日立和 NetApp 等。然而，我们在 FreeBSD 环境中可以得到一个基本系统内置的高性能 iSCSI SAN 解决方案，实在是让我们感到幸运。通过与强大的 ZFS 卷管理器和文件系统相结合，我们能得到一个灵活、可靠且快速的存储解决方案，并将其提供给网络客户端。iSCSI 子系统实现于 FreeBSD 10.0-RELEASE，并在 10.1-RELEASE 中有了诸多性能改进。
