...
我做了第二场演讲，概述 FreeBSD 项目，并讲解如何贡献代码、成为 FreeBSD 提交者。我的演讲幻灯片位于 <http://www.slideshare.net/araujobsd/portscamp-taiwan>。
...
这次聚会非常成功，我们计划在台湾另一座城市（新竹）举办第二届 PortsCamp。可能会在今年 3 月 AsiaBSDCon 之后紧接着在台湾大学举办。我们可能把 PortsCamp 改为工作组形式，相信这样更具生产力。
...
**Marcelo Araujo** 是 FreeBSD 开发者，主要工作于 Ports，近期也参与内核相关特性。他是生活在台湾的巴西人；在自由软件世界之外，Marcelo 喜欢摩托车、徒步和啤酒。
