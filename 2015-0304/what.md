...
**Dru Lavigne** 自 1997 年起将 FreeBSD 作为主要平台，是基于 FreeBSD 派生的 PC-BSD 和 FreeNAS 项目的首席文档撰写者。她是《BSD Hacks》《The Best of FreeBSD Basics》和《The Definitive Guide to PC-BSD》的作者。她是 BSD Certification Group Inc.（一家以制定 BSD 系统管理员认证标准为使命的非营利组织）的创始人兼现任主席，并担任 FreeBSD 基金会 董事会成员。
