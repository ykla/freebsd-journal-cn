...
如果你必须信任某个外部实体，DNSSEC 与证书授权机构又有何不同？去看看你的浏览器吧。你会看到几十家证书授权机构。这些机构中，有些比另一些更为谨慎、更有信誉。许多机构把证书发给了并不具备资格的组织——举例来说，不止一家 CA 把 谷歌、Apple 和 Microsoft 的证书发给了不该拿到它们的组织或个人。组织机构，即便是谨慎的 CA，也会失守。而使用 DNSSEC，你不必依赖第三方来认证身份。
