...
DevSummit 的其他亮点包括澄清 FreeBSD 的“长期支持”政策，令人欣慰的是项目实际上或多或少在遵循提议的 5 年政策。对这类政策的正式确认对从供应商到终端用户的每个人都是宝贵的营销工具。还有人提出将 FreeBSD 基本系统拆分为包，以便模块化更新和部署。处理得当的话，这对嵌入式 FreeBSD 工作将大有裨益。
