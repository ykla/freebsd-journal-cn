...
按步骤操作，并在提示时提供 PostgreSQL 数据库信息（用户名、密码）。维护 Port icinga2 的 Lars Engels 写过一篇博客文章，带你完成设置（<http://lme.postach.io/post/installing-icinga-web-2-with-apache-2-4-icinga-2-and-mysql-on-freebsd>）。
