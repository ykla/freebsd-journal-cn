...
我还与 Mark Johnston（markj@）、Joseph Mingrone（jrm@）、Bojan 和 Charlie Li（vishwin@）展开了技术和非技术讨论。意外的是，Charlie 也对 FreeBSD 音频/音乐制作感兴趣，还用它做 DJ 表演。
...
* [ShengYi Hung：《ABI stability in FreeBSD》](https://www.bsdcan.org/2025/timetable/timetable-ABI-stability-in.html)，展示了检测 CTF 数据差异的实验性工具，用于发现 ABI 变化。之后我们（包括我、Mark Johnston、John Baldwin、Warner Losh 和讲者本人）展开了关于工具局限性及如何在实际应用中的讨论。
* [Marshall Kirk McKusick：《A History of the BSD Daemon》](https://www.bsdcan.org/2025/timetable/timetable-A-History-of.html)，和即将出版的《FreeBSD 操作系统设计与实现》（*The Design and Implementation of the FreeBSD Operating System*）第三版更新。我一向喜欢 Kirk 的演讲风格。
...
会议闭幕式后，我们去附近的市场广场参加社交活动。我大部分时间和 Mark Johnston、Andreas Kirchner、Mateusz Piotrowski 在一起，聊了很多有趣的话题。

第二天，我返回蒙特利尔，休息了几天才回家。

一如既往，会议是弥补编程孤独的绝佳机会，让我们能见到每天通过邮件交流的幕后人。除了完成工作和交换技术想法，我更享受那些意外发生的、深入的讨论，包括与此前未曾见过的人。
