...
LKPI 使得将 Linux DRM 驱动程序带到 FreeBSD 变得更容易，修改最小，并能够保持与 Linux 上游的同步。2018 年晚些时候，drm1 和 drm2 被从内核移到 Ports 树，作为 drm-legacy-kmod Port；而 drm-next Port 则采用了原始名称“drm-kmod”。
