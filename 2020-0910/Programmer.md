...
我们 Weblate 实例，每天都会构建所有翻译，并且可以通过 <https://doc.fugbr.org/jenkins/> 获取。我们为所有新语言启用了这些构建。如果你想加快这个过程，你可以随时告诉 Weblate 提交你的翻译，然后通过我们的 Jenkins 触发构建过程，几分钟后你就可以进行校对。
...
完成任何文档的翻译后，提交将是将你的工作正式推送到 FreeBSD 网站的最后一步。
