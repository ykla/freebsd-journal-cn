...
FreeBSD 基金会与 Netgate 合作，由 FreeBSD 开发者 John-Mark Gurney 为 FreeBSD 加密框架添加 AES-CTR 和 AES-GCM 模式，包括利用 Intel AES-NI 指令的加速。AES-GCM 是一种认证加密算法，非常适合保护分片数据，因为它延迟最低、操作开销最小。
