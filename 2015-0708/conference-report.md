...
**SHONALI BALAKRISHNA** 是 2014 年 FreeBSD 项目的谷歌 Summer of Code 学生，为 BSNMP 项目做出贡献，致力于为 BSNMP 添加 IPv6 支持。她目前是加州大学欧文分校网络系统专业的硕士研究生。Shonali 拥有电信工程学士学位，本科研究和论文带来两篇研究论文发表。她目前的研究兴趣位于分布式系统和机器学习的交叉点，她也希望继续为 FreeBSD 贡献代码。
