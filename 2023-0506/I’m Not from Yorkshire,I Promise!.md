...
我这篇文章的初稿保存在文件名为“Unix_from_Yorkshire.txt”的文件中，随着文章变得越来越长，越发像是 UNIX 版本的蒙提·派森的“[四个约克郡人](https://juejin.cn/s/monty%20python%20sketch%20four%20yorkshiremen%20script)”小品：
...
他们可能也不会读它，因为虽然这样的故事在痛饮啤酒时可以提供不错的调剂，但在白天阅读时会显得枯燥乏味而单调。
...
作为未来的预兆，版本发布两周后，我在 comp.unix.bsd 的第一篇文章就是关于磁盘驱动器几何结构问题，因为那时存在臭名昭著的 1024 柱面限制【[参考](http://blog.chinaunix.net/uid-15797451-id-3438370.html)】。
...
他们希望得到一个高度可移植的、纯正的 BSD UNIX，可以在各种硬件上运行：比如 HP、Sun、Digital、IBM PC 等，而这其中我既没有接触的机会，也对此不感兴趣。
