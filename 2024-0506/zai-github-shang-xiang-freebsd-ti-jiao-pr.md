...
![FreeBSD PR 提交流程图](../png/2024-0506/zai-github-shang-xiang-freebsd-ti-jiao-pr-1.png)
...
![GitHub Fork 菜单示意图](../png/2024-0506/zai-github-shang-xiang-freebsd-ti-jiao-pr-2.jpg)

图 1：单击“Fork”旁边的向下箭头后，你将看到一个弹出式窗口，显示创建复刻的对话框。

![GitHub 创建复刻界面](../png/2024-0506/zai-github-shang-xiang-freebsd-ti-jiao-pr-3.png)

图 2：创建复刻，第 2 部分。

在你点击“Create Fork（创建复刻）”后，GUI 将重定向到新复刻的存储库。你可以在常规位置复制克隆版本库所需的 URL，如图 3 所示。

![GitHub 克隆 URL 示意图](../png/2024-0506/zai-github-shang-xiang-freebsd-ti-jiao-pr-4.png)
...
![GitHub PR 提交表单](../png/2024-0506/zai-github-shang-xiang-freebsd-ti-jiao-pr-5.png)
